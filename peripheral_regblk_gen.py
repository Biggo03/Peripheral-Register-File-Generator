...
def generate_macros(peripheral_name, yaml_file, macro_dir):
    ...
    with open(macro_path, "w") as f:
        ...
        f.write("//\n")
        f.write("//  Generated by: Peripheral Register File Generator\n")
        f.write("//  Repository:   https://github.com/Biggo03/Peripheral-Register-File-Generator\n")
        f.write(f"//  Revision:     {git_revision}\n")
        f.write(f"//  Generated on: {generation_timestamp}\n")
        f.write("//\n")
        f.write("//  Any manual changes will be overwritten.\n")
        f.write("// -----------------------------------------------------------------------------\n")
